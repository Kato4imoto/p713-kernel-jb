...
/* LGE_CHANGE_E : 2012-10-13 sungmin.cho@lge.com hi707 is ratated 180 degree. EVB2 no flip, others xy flip */
	...
	{0x03, 0x20},  //page 20
#ifdef LGE_CAMERA_ANTIBAND_50HZ
	{0x10, 0x1c},  //ae off
#else
	{0x10, 0x0c},  //ae off
#endif
...
static struct msm_camera_i2c_reg_conf hi707_night_mode[][40] = {
	/*NIGHT MODE OFF*/
	{
		//		{0x03, 0x00},                            
		//		{0x01, 0x71}, // SLEEP ON                
...
#if 0
#ifdef LGE_CAMERA_ANTIBAND_50HZ	
		{0x83, 0x02}, //EXP Normal 10.00 fps 
		{0x84, 0x49}, 
		{0x85, 0xf0}, 
#else
		{0x83, 0x02}, //EXP Normal 10.00 fps 
...
static struct msm_camera_i2c_conf_array hi707_night_mode_confs[][1] = {
	{{hi707_night_mode[0], ARRAY_SIZE(hi707_night_mode[0]),  0,
		MSM_CAMERA_I2C_BYTE_DATA},},
	{{hi707_night_mode[1], ARRAY_SIZE(hi707_night_mode[1]),  0,
		MSM_CAMERA_I2C_BYTE_DATA},},
};
...
static struct msm_camera_i2c_reg_conf hi707_fps_range[][49] = {
...
static struct msm_camera_i2c_conf_array hi707_fps_range_confs[][1] = {
	{{hi707_fps_range[0], ARRAY_SIZE(hi707_fps_range[0]),  0,
		MSM_CAMERA_I2C_BYTE_DATA},},
	{{hi707_fps_range[1], ARRAY_SIZE(hi707_fps_range[1]),  0,
		MSM_CAMERA_I2C_BYTE_DATA},},
	{{hi707_fps_range[2], ARRAY_SIZE(hi707_fps_range[2]),  0,
		MSM_CAMERA_I2C_BYTE_DATA},},
	{{hi707_fps_range[3], ARRAY_SIZE(hi707_fps_range[3]),  0,
		MSM_CAMERA_I2C_BYTE_DATA},},
	{{hi707_fps_range[4], ARRAY_SIZE(hi707_fps_range[4]),  0,
		MSM_CAMERA_I2C_BYTE_DATA},},
};
