...
static struct msm_camera_i2c_reg_conf mt9e013_lgit_prev_settings[] = {
...
static struct msm_camera_i2c_reg_conf mt9e013_lgit_snap_settings[] = {
...
static struct msm_camera_i2c_reg_conf mt9e013_lgit_hfr60_settings[] = {
...
static struct msm_camera_i2c_reg_conf mt9e013_lgit_hfr90_settings[] = {
	{0x0300, 0x0005},/*VT_PIX_CLK_DIV*/
	{0x0302, 0x0001},/*VT_SYS_CLK_DIV*/
	{0x0304, 0x0002},/*PRE_PLL_CLK_DIV*/
...
static struct msm_camera_i2c_reg_conf mt9e013_lgit_hfr120_settings[] = {
	{0x0300, 0x0005},/*VT_PIX_CLK_DIV*/
	{0x0302, 0x0001},/*VT_SYS_CLK_DIV*/
	{0x0304, 0x0002},/*PRE_PLL_CLK_DIV*/
...
static struct msm_camera_i2c_reg_conf mt9e013_lgit_recommend_settings[] = {
...
static struct msm_camera_i2c_conf_array mt9e013_lgit_init_conf[] = {
	{&mt9e013_lgit_recommend_settings[0],
	ARRAY_SIZE(mt9e013_lgit_recommend_settings), 0, MSM_CAMERA_I2C_WORD_DATA}
};

static struct msm_camera_i2c_conf_array mt9e013_lgit_confs[] = {
	{&mt9e013_lgit_snap_settings[0],
	ARRAY_SIZE(mt9e013_lgit_snap_settings), 0, MSM_CAMERA_I2C_WORD_DATA},
	{&mt9e013_lgit_prev_settings[0],
	ARRAY_SIZE(mt9e013_lgit_prev_settings), 0, MSM_CAMERA_I2C_WORD_DATA},
	{&mt9e013_lgit_hfr60_settings[0],
	ARRAY_SIZE(mt9e013_lgit_hfr60_settings), 0, MSM_CAMERA_I2C_WORD_DATA},
	{&mt9e013_lgit_hfr90_settings[0],
	ARRAY_SIZE(mt9e013_lgit_hfr90_settings), 0, MSM_CAMERA_I2C_WORD_DATA},
	{&mt9e013_lgit_hfr120_settings[0],
	ARRAY_SIZE(mt9e013_lgit_hfr120_settings), 0, MSM_CAMERA_I2C_WORD_DATA},
};
...
int32_t mt9e013_lgit_sensor_power_up(struct msm_sensor_ctrl_t *s_ctrl)
{
	int32_t rc = 0;
...
int32_t mt9e013_lgit_sensor_power_down(struct msm_sensor_ctrl_t *s_ctrl)
{
	struct msm_camera_sensor_info *data = s_ctrl->sensordata;
	int32_t rc = 0;
...
static struct msm_sensor_fn_t mt9e013_lgit_func_tbl = {
	...
	.sensor_power_up = mt9e013_lgit_sensor_power_up,
	.sensor_power_down = mt9e013_lgit_sensor_power_down,
	.sensor_get_csi_params = msm_sensor_get_csi_params,
	//.sensor_match_id = mt9e013_lgit_match_id,
};
